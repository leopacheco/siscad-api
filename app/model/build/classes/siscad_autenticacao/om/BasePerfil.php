...
abstract class BasePerfil extends BaseObject implements Persistent
{
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[] = PerfilPeer::DESCRICAO;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PerfilPeer::DESCRICAO)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PerfilPeer::DESCRICAO)) $criteria->add(PerfilPeer::DESCRICAO, $this->descricao);
    ...
    public function setPerfilEndpoints(PropelCollection $perfilEndpoints, PropelPDO $con = null)
    {
        ...
        foreach ($perfilEndpointsToDelete as $perfilEndpointRemoved) {
            $perfilEndpointRemoved->setPerfil(null);
        }
     ...
     * @return PropelObjectCollection|PerfilEndpoint[] List of PerfilEndpoint objects
     */
    public function getPerfilEndpointsJoinEndpoint($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PerfilEndpointQuery::create(null, $criteria);
        $query->joinWith('Endpoint', $join_behavior);
