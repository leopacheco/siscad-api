...
abstract class BasePerfilPeer
{
    ...
    const DESCRICAO = 'perfil.descricao';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID, PerfilPeer::NOME, PerfilPeer::DESCRICAO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOME', 'DESCRICAO', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID => 0, PerfilPeer::NOME => 1, PerfilPeer::DESCRICAO => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOME' => 1, 'DESCRICAO' => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PerfilPeer::DESCRICAO);
        } else {
